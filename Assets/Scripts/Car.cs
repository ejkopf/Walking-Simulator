...
public class Car : MonoBehaviour
{
    ...
    void Start()
    {
        car.transform.position = new Vector3(car.transform.position.x, car.transform.position.y, car.transform.position.z + 300f);
    ...
    void FixedUpdate()
    {
        if (initposcar > 0 && !call1.activeInHierarchy && !call2.activeInHierarchy)
        {
            car.transform.position = new Vector3(car.transform.position.x, car.transform.position.y, car.transform.position.z + 0.15f);
            if (car.transform.position.z > maincamera.transform.position.z + 20f)
            {
                carFar = true;
        ...
        else if (!call1.activeInHierarchy && !call2.activeInHierarchy)
        {
            car.transform.position = new Vector3(car.transform.position.x, car.transform.position.y, car.transform.position.z - 0.15f);
